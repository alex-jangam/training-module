...
var schema = new Schema({
    ...
    "user": String,//user to which the question is tagged.
    "submitted": Boolean,//is Submitted state?
    "admin" : [String],//Optional selection of admins
...
var paginate = 10, defKeys = ["name", "code", "course", "suffix", "created", "lastUpdated"],
